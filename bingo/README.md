...
- **Stack:** Vite + React 19 + TypeScript, Supabase (Postgres + Realtime) jako backend, Vercel jako hosting.
...
3. „Rozdaj plansze i start” losuje każdemu graczowi planszę z puli. Spóźnialscy losują sobie planszę sami.
